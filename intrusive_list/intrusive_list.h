...
struct list_element_base {
  ...
  list_element_base(const list_element_base&) = delete;
  list_element_base& operator=(const list_element_base&) = delete;

  bool is_single() noexcept;
...
struct list_element : private list_element_base {
  ...
  list_element(const list_element& other) = delete;
  list_element& operator=(const list_element& other) = delete;
